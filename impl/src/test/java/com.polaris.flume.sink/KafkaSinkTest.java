...
import com.polaris.flume.sink.util.TestUtil;
...
public class KafkaSinkTest {
    ...
    public void testPreprocessorForCustomKey(){
        ...
        context.put(Constants.PREPROCESSOR, "com.polaris.flume.sink.preprocessor.ModifyKeyPreprocessor");
    ...
    public void testPreprocessorForCustomTopic(){
        ...
        context.put(Constants.TOPIC, TestConstants.STATIC_TOPIC);
        // configure the preprocessor
        context.put(Constants.PREPROCESSOR, "com.polaris.flume.sink.preprocessor.ModifyTopicPreprocessor");
    ...
    public void testPreprocessorForCustomMessageBody(){
        ...
        context.put(Constants.TOPIC, TestConstants.STATIC_TOPIC);
        // configure the preprocessor
        context.put(Constants.PREPROCESSOR, "com.polaris.flume.sink.preprocessor.ModifyMessageBodyPreprocessor");
